...
// BASE_URL 来自 base 配置（"/Blog"），拼接时手动加斜杠
...
const site = {
  ...
  navigation: [
    { name: "Home", subtitle: "Index", href: `${BASE_URL}/` },
    { name: "Writing", subtitle: "Blog", href: `${BASE_URL}/posts` },
    { name: "Projects", subtitle: "Works", href: `${BASE_URL}/projects` },
    { name: "Friends", subtitle: "Links", href: `${BASE_URL}/friends` },
    { name: "About", subtitle: "Me", href: `${BASE_URL}/about` },
  ],
